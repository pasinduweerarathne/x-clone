...
async function main() {
  ...
  await prisma.follow.createMany({
    data: [
      { follwerId: users[0].id, followingId: users[1].id },
      { follwerId: users[0].id, followingId: users[2].id },
      { follwerId: users[1].id, followingId: users[3].id },
      { follwerId: users[2].id, followingId: users[4].id },
      { follwerId: users[3].id, followingId: users[0].id },
    ],
  });
